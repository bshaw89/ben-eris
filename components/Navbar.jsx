...
export const Navbar = () => {
    ...
    return (
        ...
        <Link href='/'>
            ...
            whileTap={{ scale: 0.9 }}
            class="text-center text-xl font-bold mt-1 mb-1 opacity:50 hover:text-warlock-400/90 hover:text-shadow-lg hover:shadow-warlock-400 text-white">{config.home}
            </motion.button>
        </Link>
        <Link href='/lyrics'>
            <motion.button
