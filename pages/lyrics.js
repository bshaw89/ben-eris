...
export default function Lyrics({ configData }) {
    ...
    <div className="bg-album-cover bg-right-top" style={{backgroundSize: '450%'}}>
        ...
        <TransitionWrapper>
    <div className="flex flex-col justify-center items-center w-screen h-screen p-6 bg-right-top bg-album-cover" style={{backgroundColor: `${configData.bgColor}`, backgroundSize: '450%'}}>
