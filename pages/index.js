...
export default function Home({ configData }) {
  return (
    ...
    <div className="flex flex-col justify-center items-center w-screen h-screen p-6 bg-auto" style={{background: `${configData.backgroundImage}`, backgroundPosition: "right", backgroundColor: `${configData.bgColor}`, backgroundSize: '250%'}}>
      ...
      <div className="flex flex-col justify-center align-center w-full h-[80%] items-center">
      {/* <div className="landscape:flex-row landscape:w-2/3 landscape:items-start flex flex-col justify-center align-center w-full lg:w-1/2 md:w-1/3 h-[80%] lg:h-1/2 md:h-1/2 items-center"> */}
        ...
        <div className="hover:animate-pulse w-full h-1/3 flex flex-col justify-start items-center">
